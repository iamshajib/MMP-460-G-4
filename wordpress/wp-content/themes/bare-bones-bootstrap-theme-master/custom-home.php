<?php /* Template Name: Custom Home Page Template */ ?>
    <?php get_header(); ?>
        ...
        <div class="container-fluid text-center" id="home-wrapper">

            <div class="row">

                <a href="http://group.bmcc.is/g4_sp16/vat/">
                    <div class="col-xm-12 col-sm-4 col-md-4 col-lg-4 tiles" id="h-vat">

                        <img class="img-responsive" src="http://group.bmcc.is/g4_sp16/wp-content/uploads/2016/05/1.png">
                        <h1>Video Arts and Technology</h1>
                ...
                <a href="http://group.bmcc.is/g4_sp16/mmd/">
                    <div class="col-xm-12 col-sm-4 col-md-4 col-lg-4 tiles" id="h-mmd">
                        <img class="img-responsive" src="http://group.bmcc.is/g4_sp16/wp-content/uploads/2016/05/2.png">
                        <h1>Multimedia Programming and Design</h1>
                        <div class="col-md-12 slider">
                            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                <!-- Wrapper for slides -->
                                <div class="carousel-inner" role="listbox">
                ...
                <a href="http://group.bmcc.is/g4_sp16/ani/">
                    <div class="col-xm-12 col-sm-4 col-md-4 col-lg-4 tiles" id="h-ani">

                        <img class="img-responsive" src="http://group.bmcc.is/g4_sp16/wp-content/uploads/2016/05/3.png">

                        <h1>Animation and Motion Graphics</h1>
